...
batch06 MSG_201 (첨부 리스트 observe, 무입력)이 2-run green + draft 무생성 관찰로 확정되면 연쇄 승격 후보 (**MSG_201 배정은 사용자 승인 2026-06-11 — editor/compose-entry 3건과 함께, 다음 F0 세션 manifest 포함 대상**):
