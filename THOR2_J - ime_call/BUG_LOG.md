...
|---|---|---|---|---|---|---|
| IME-CALL-001 | 다이얼러 하드키 입력 | CONFIRMED | OPEN | a11y 연결 후 하드 `*` 삼킴 (sticky, 재부팅 리셋) | — | RESULT_2026-07-07 §ISSUE-1 |
...
- **앱**: com.android.dialer 1.0.0.1638 (ls_dialer) / IME iWnn 2.23.1.10
