...
- run_id: `20260604T102316Z` · generated_at_utc: `2026-06-04T10:27:24Z`
...
focus_mismatch: 2
dump_rejected: 0
denylist_recorded: 27
observed_texts_total: 368
...
- observed_texts: ko=45, en=3, other=0 · scroll 7 pass (no_new)
...
| 97%: 25분 후 충전 완료 | menu_row | summary | none |
...
- reach: `FOCUS_MISMATCH` (kind=None) · focus `com.android.settings/com.android.settings.Settings$MyDeviceInfoActivity` · fp `None`
...
- nav_path: 설정 → 위치
- reach: `REACHED` (kind=internal) · focus `com.android.settings/com.android.settings.Settings$LocationSettingsActivity` · fp `9eeca182`
...
- nav_path: 설정 → Wi-Fi
- reach: `REACHED` (kind=internal) · focus `com.android.settings/com.android.settings.Settings$WifiSettingsActivity` · fp `1a079849`
- observed_texts: ko=21, en=14, other=0 · scroll 4 pass (no_new)
...
| snri12,Wi-Fi 신호가 강합니다.,보안 네트워크 | menu_row | unknown | none |
...
| DIRECT-D0 C51x Series,Wi-Fi 신호 막대가 한 개입니다.,보안 네트워크 | menu_row | unknown | none |
...
- nav_path: 설정 → 날짜 및 시간
- reach: `REACHED` (kind=internal) · focus `com.android.settings/com.android.settings.Settings$DateTimeSettingsActivity` · fp `efc95f0e`
...
- observed_texts: ko=8, en=0, other=0 · scroll 2 pass (no_new)
